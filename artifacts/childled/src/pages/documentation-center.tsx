            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-muted-foreground">
                  ChildLed uses only meaning-backed utterances explicitly confirmed as Child, plus
...
AI-generated draft for clinician review only. ChildLed does not provide diagnoses, clinical decisions, or treatment recommendations. Clinical interpretation and approval remain the responsibility of the licensed professional.
`;
  };
  ...
  return (
    <article className="rounded-3xl border border-border bg-card p-4 shadow-sm sm:p-6 md:p-9 print:border-none print:p-0 print:shadow-none animate-rise">
      ...
      <footer className="mt-8 border-t border-border pt-5 text-xs leading-5 text-muted-foreground">
        ...
        ChildLed does not assign an NLA stage or provide diagnoses, clinical decisions, or
