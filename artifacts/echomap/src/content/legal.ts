...
export const LEGAL_REVIEW_NOTICE =
  'Template notice: Replace the placeholders below with your organization’s reviewed policy before using EchoMap in production. This page is not legal advice and does not itself certify HIPAA, FERPA, or other regulatory compliance.';
...
export const privacyPolicySections = [
  ...
  },
  {
    ...
    body: 'EchoMap requires an explicit legal-authority confirmation before a child profile is created. Placeholder: Describe consent withdrawal, recordkeeping, and age- or jurisdiction-specific requirements.',
  },
  {
...
export const termsOfUseSections = [
  {
    ...
    body: 'EchoMap is intended to help teams organize observations and communication context. Placeholder: State the organization’s intended use and any population, age, or geographic limits.',
  },
  {
    title: 'Professional judgment',
    body: 'EchoMap does not replace the judgment of a licensed professional, individualized assessment, diagnosis, treatment plan, or emergency services. Users remain responsible for appropriate professional consultation.',
  },
  {
