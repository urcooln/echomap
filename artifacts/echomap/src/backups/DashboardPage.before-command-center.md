...
To restore, replace the `DashboardPage` function in `artifacts/echomap/src/App.tsx` with the function below. The surrounding Clerk authentication, routes, navigation, API queries, and child-profile functionality remain unchanged.
