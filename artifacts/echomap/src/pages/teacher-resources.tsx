...
export function TeacherResourcesPage({ childId }: { childId?: number }) {
  ...
  const download = async () => {
    ...
    try { const blob = await downloadTeacherResourceHandbook({ childId }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = 'EchoMap-Teacher-Resources.pdf'; a.click(); URL.revokeObjectURL(url); }
